...
page 50120 "AST Power BI Assignments"
{
    PageType = API; APIPublisher = 'KrishnaveniMudaliyar'; APIGroup = 'assetTracking';
    APIVersion = 'v1.0'; EntityName = 'astPbiAssignment'; EntitySetName = 'astPbiAssignments';
    SourceTable = "AST Posted Assignment Header"; ODataKeyFields = "No.";
