page 50121 "AST Power BI Assignment Lines"
{
    ...
    APIVersion = 'v1.0'; EntityName = 'astPbiAssignmentLine'; EntitySetName = 'astPbiAssignmentLines';
    SourceTable = "AST Posted Assignment Line"; ODataKeyFields = "Document No.", "Line No.";
