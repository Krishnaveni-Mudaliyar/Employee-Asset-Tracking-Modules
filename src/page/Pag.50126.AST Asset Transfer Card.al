    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("From Employee Name"; Rec."From Employee Name") { ApplicationArea = All; Editable = false; }
                ...
                field("To Employee Name"; Rec."To Employee Name") { ApplicationArea = All; Editable = false; }
                field("To Department"; Rec."To Department") { ApplicationArea = All; }
                field("Transfer Date"; Rec."Transfer Date") { ApplicationArea = All; }
                field(Reason; Rec.Reason) { ApplicationArea = All; MultiLine = true; }
                ...
                field("Approval Date"; Rec."Approval Date") { ApplicationArea = All; Editable = false; }
            }
