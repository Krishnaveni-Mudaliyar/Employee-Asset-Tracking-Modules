// Extends the AST Asset Cue with new tiles and actions:
//   - Overdue Returns (using Is Overdue flag from extension)
...
pageextension 50104 ASTAssetCueExt extends "AST Asset Cue"
{
        ...
        addlast(Assignments)
        {
            field(OverdueByFlag; OverdueByFlag)
            {
                ...
                begin
                    ...
                    Page.Run(Page::"AST Posted Assignment List", lHdr);
                end;
            }
    ...
    begin
        ...
        lRes.SetRange(Status, "AST Reservation Status"::Active);
        ActiveReservations := lRes.Count();

        lTrf.SetRange(Status, "AST Transfer Status"::Open);
