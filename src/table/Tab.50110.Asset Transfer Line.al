table 50110 "Asset Transfer Line"
{
    Caption = 'Asset Transfer Line';

    fields
    {
        field(1; "Document No."; Code[20]) { Caption = 'Document No.'; TableRelation = "Asset Transfer Header"; DataClassification = CustomerContent; }
        field(2; "Line No."; Integer) { Caption = 'Line No.'; DataClassification = CustomerContent; }
        field(3; "Asset No."; Code[20]) { Caption = 'Asset No.'; TableRelation = "Company Asset"; DataClassification = CustomerContent; }
        ...
        field(7; Condition; Enum "Asset Condition") { Caption = 'Condition'; DataClassification = CustomerContent; }
