table 50102 "Company Asset"
{
    Caption = 'Company Asset';
    DrillDownPageId = "Company Asset List";
    LookupPageId = "Company Asset List";
    ...
    fields
    {
        ...
        field(4; "Category Description"; Text[100])
        {
            ...
            CalcFormula = Lookup("Asset Category".Description
        ...
        field(6; Status; Enum "Asset Status")
        {
            Caption = 'Status';
            DataClassification = CustomerContent;
            Editable = false;
        }
        field(7; Condition; Enum "Asset Condition")
        {
            Caption = 'Condition';
            DataClassification = CustomerContent;
        }
