table 50104 "Asset Assignment Line"
{
    ...
    fields
    {
        field(1; "Document No."; Code[20])
        {
            ...
            TableRelation = "Asset Assignment Header";
        }
        ...
        field(4; "Asset Description"; Text[100])
        {
            ...
            CalcFormula = Lookup("Company Asset".Description
where("No." = field("Asset No.")));
        ...
        field(5; "Serial No."; Text[50])
        {
            Caption = 'Serial No.';
            FieldClass = FlowField;
            CalcFormula = Lookup("Company Asset"."Serial No."
            where("No." = field("Asset No.")));
            Editable = false;
        }
        field(6; "Category Code"; Code[20])
        {
            ...
            FieldClass = FlowField;
            CalcFormula = Lookup("Company Asset"."Category Code"
            where("No." = field("Asset No.")));
            Editable = false;
        }
        field(7; "Condition at Handover"; Enum "Asset Condition")
        {
