table 50109 "AST Asset Transfer Header"
{
    Caption = 'Asset Transfer Header';
    LookupPageId = "AST Asset Transfer List";
    DrillDownPageId = "AST Asset Transfer List";
    ...
    fields
    {
        ...
        field(9;  Status;                   Enum "AST Transfer Status")    { Caption = 'Status'; Editable = false; DataClassification = CustomerContent; }
        field(10; Reason;                   Text[250])                     { Caption = 'Reason'; DataClassification = CustomerContent; }
        field(11; "No. of Lines";           Integer)                       { Caption = 'No. of Lines'; FieldClass = FlowField; CalcFormula = Count("AST Asset Transfer Line" where("Document No." = field("No."))); Editable = false; }
    ...
    trigger OnDelete()
    var lLine: Record "AST Asset Transfer Line";
    begin
