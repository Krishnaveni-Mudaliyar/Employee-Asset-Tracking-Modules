table 50100 "Asset Tracking Setup"
{
    Caption = 'Asset Tracking Setup';
    DrillDownPageId = "Asset Tracking Setup";
    LookupPageId = "Asset Tracking Setup";
    ...
    fields
    {
        ...
        field(6; "Default Asset Condition"; Enum "Asset Condition")
        {
