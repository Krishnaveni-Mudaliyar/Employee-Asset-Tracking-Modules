// Daily job queue codeunit.
// Scans AST Posted Assignment Header for entries where:
//   - Transaction Type = Assignment
//   - Return Date = 0D (not yet returned)
//   - Expected Return Date < Today
// Sets Is Overdue = TRUE, stamps Overdue Since Date, refreshes Overdue Days.
// Clears flag when Return Date is present.
// Sends email alert via Cod.50109 if enabled.
codeunit 50108 "AST Overdue Management"
{
    ...
    begin
        ...
        lHdr.SetRange("Transaction Type", "AST Transaction Type"::Assignment);
