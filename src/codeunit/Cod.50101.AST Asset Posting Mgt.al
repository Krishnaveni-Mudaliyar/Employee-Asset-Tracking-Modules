    ...
    begin
        ...
        if lRecLine.FindSet() then
            repeat
                ...
                lCodLogMgt.CreateLogEntry(lRecAsset, lEnumStatusBefore, lRecAsset.Status::Assigned, "AST Transaction Type"::Assignment, pRecHeader."No.", pRecHeader."Employee No.", pRecHeader."Employee Name");
            until lRecLine.Next() = 0;
    end;
